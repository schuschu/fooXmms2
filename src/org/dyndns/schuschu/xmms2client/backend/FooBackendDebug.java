...
public class FooBackendDebug extends OutputStream implements
	...
	public static void registerFactory() {
		FooFactorySub factory = new FooFactorySub() {
			...
			public Object create(Element element) {
				...
				debugBackend.registerActionFactory();
	...
	public FooAction ActionClear(int code) {
		return new ActionClear(code, this);
	}

	private class ActionClear extends FooAction {

		private final FooBackendDebug backend;

		public ActionClear(int code, FooBackendDebug backend) {
			super("deselect", code);
